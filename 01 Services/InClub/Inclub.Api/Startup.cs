...
using Inclub.Api.Infrastructure.AutofacModules;
using Inclub.Api.Infrastructure.Filters;
using Inclub.Api.Infrastructure.Services;
using Inclub.Infrastructure;
using Inclub.Infrastucture.Extensions;
...
namespace Inclub.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger()
               .UseSwaggerUI(c =>
               {
                   c.SwaggerEndpoint($"{ (!string.IsNullOrEmpty(pathBase) ? pathBase : string.Empty) }/swagger/v1/swagger.json", "Inclub.API V1");
                   c.OAuthAppName("Inclub Swagger UI");
               });
    ...
    static class CustomExtensionsMethods
    {
        ...
        {
            services.AddDbContext<InclubContext>(options =>
            {
        ...
        public static IServiceCollection AddCustomIntegrations(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            //services.AddTransient<IDaxsportIntegrationEventService, DaxsportIntegrationEventService>();
